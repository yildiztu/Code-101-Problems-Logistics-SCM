...
& $py -m jupyter nbconvert --to notebook --execute (Join-Path $root "Part II - The End-to-End Supply Chain (Problems 47-101)\D. Strategic Network Design & Sourcing (The Blueprint of the Business)\085. The Uncapacitated Facility Location Problem\P85-Tier-2.ipynb") --output-dir $dir --ExecutePreprocessor.timeout=1800
