#!/usr/bin/env python3
"""
JSON validation for P70 Minimum Spanning Tree Problem notebooks
"""
...
def validate_notebook_json(file_path):
    ...
    try:
        ...
        # Check for name property in language_info
        language_info = metadata['language_info']
        if 'name' not in language_info:
            return False, "Missing 'name' property in language_info"
...
def main():
    ...
    print("=" * 60)
    print("P70 MINIMUM SPANNING TREE PROBLEM - JSON VALIDATION")
    print("=" * 60)
