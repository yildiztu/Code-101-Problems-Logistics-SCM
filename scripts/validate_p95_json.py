...
def main():
    ...
    p95_dir = Path("Part II - The End-to-End Supply Chain (Problems 47-101)/095. The Supply Chain Network Design under Uncertainty Problem")
    
    if not p95_dir.exists():
        print("P95 directory not found")
        print(f"Looking in: {p95_dir.absolute()}")
        return
