...
# Check P48 notebooks
p48_dir = 'Part II - The End-to-End Supply Chain (Problems 47-101)/A. Foundational Analytics & Inventory Control (The Language of Supply Chain)/048. The Demand Forecasting - Exponential Smoothing Problem'
...
# Check P51 notebooks  
p51_dir = 'Part II - The End-to-End Supply Chain (Problems 47-101)/A. Foundational Analytics & Inventory Control (The Language of Supply Chain)/051. The Classic Economic Order Quantity (EOQ) Problem'
